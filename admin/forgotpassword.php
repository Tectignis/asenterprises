...
?>
<?php session_start();
$res=mysqli_query($conn,"SELECT * FROM `admin_login`");
...
<?php
		...
		if(isset($_POST['forget'])){
			...
			$email=$_POST['mail'];
			$q=mysqli_query($conn,"select * from admin_login where email='$email'");
        ...
        //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
				...
				//Recipients
				$mail->setFrom('divyani.keshari@tectignis.in','Support ASENTERPRISES');
				...
				if($mail->send()){
					...
					$q1=mysqli_query($conn,"update admin_login set password= '$passwordhash' where email='$email'");
						if($q1){
